...
impl ToTokens for BoundedIntegerDef {
    fn to_tokens(&self, tokens: &mut TokenStream) {
        ...
        let bounded_integer = quote!(crate::types::bounded_integer::BoundedInteger);
        let bounded_integer_error = quote!(crate::types::bounded_integer::BoundedIntegerError);
        let ser_fn = quote!(crate::types::bounded_integer::serialize_bounded_integer);
        let des_fn = quote!(crate::types::bounded_integer::deserialize_bounded_integer);
...
impl ToTokens for BoundedNumberDef {
    fn to_tokens(&self, tokens: &mut TokenStream) {
        ...
        let bounded_number = quote!(crate::types::bounded_number::BoundedNumber);
        let bounded_number_error = quote!(crate::types::bounded_number::BoundedNumberError);
        let ser_fn = quote!(crate::types::bounded_number::serialize_bounded_number);
        let des_fn = quote!(crate::types::bounded_number::deserialize_bounded_number);
...
impl ToTokens for BoundedStringDef {
    fn to_tokens(&self, tokens: &mut TokenStream) {
        ...
        let ser_fn = quote!(crate::types::bounded_string::serialize_bounded_string);
        let des_fn = quote!(crate::types::bounded_string::deserialize_bounded_string);
