...
impl<'a, T> crate::ProxmoxClient for &'a GroupClient<T>
where
    T: crate::client::Client,
{
    type Path = &'a str;
...
impl<T> crate::proxmox_client::ProxmoxClientAction<(), (), T::Error> for &GroupClient<T>
where
    T: crate::client::Client,
{
...
impl<T> crate::proxmox_client::ProxmoxClientAction<PostParams, (), T::Error> for &GroupClient<T>
where
    T: crate::client::Client,
{
