...
pub struct BlockingResourcesPostOutputBlockingResourcesItems {
    #[doc = "The reason why the HA resource is blocking the relocation."]
    #[doc = ""]
    pub cause: Cause,
...
impl PostOutput {
    pub fn new(requested_node: String, sid: String) -> Self {
        Self {
            ...
            comigrated_resources: ::std::default::Default::default(),
            additional_properties: ::std::default::Default::default(),
        }
    }
}
...
pub struct PostOutput {
    ...
    #[doc = "HA resources, which are blocking the given HA resource from being relocated to the requested target node."]
    #[doc = ""]
    pub blocking_resources: Vec<BlockingResourcesPostOutputBlockingResourcesItems>,
    #[serde(rename = "comigrated-resources")]
    #[serde(skip_serializing_if = "::std::vec::Vec::is_empty", default)]
    #[doc = "HA resources, which are relocated to the same requested target node as the given HA resource, because these are in positive affinity with the HA resource."]
    #[doc = ""]
    pub comigrated_resources: Vec<String>,
    #[serde(rename = "requested-node")]
    #[doc = "Node, which was requested to be relocated to."]
    #[doc = ""]
    pub requested_node: String,
    #[doc = "HA resource, which is requested to be relocated."]
    #[doc = ""]
    pub sid: String,
    #[serde(
        flatten,
