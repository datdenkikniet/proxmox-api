...
impl<'a, T> crate::ProxmoxClient for &'a ResourcesClient<T>
where
    T: crate::client::Client,
{
    type Path = &'a str;
...
impl<T> crate::proxmox_client::ProxmoxClientAction<PostParams, (), T::Error> for &ResourcesClient<T>
where
    T: crate::client::Client,
{
