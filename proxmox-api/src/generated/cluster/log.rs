...
pub struct MaxInt(i128);
impl crate::types::bounded_integer::BoundedInteger for MaxInt {
...
impl std::convert::TryFrom<i128> for MaxInt {
    type Error = crate::types::bounded_integer::BoundedIntegerError;
    fn try_from(value: i128) -> Result<Self, Self::Error> {
        crate::types::bounded_integer::BoundedInteger::new(value)
    }
}
impl ::serde::Serialize for MaxInt {
...
impl<'de> ::serde::Deserialize<'de> for MaxInt {
