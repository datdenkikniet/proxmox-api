...
pub struct ValidationDelayInt(i128);
impl crate::types::bounded_integer::BoundedInteger for ValidationDelayInt {
    const MIN: Option<i128> = Some(0i128);
    const MAX: Option<i128> = Some(172800i128);
    const DEFAULT: Option<i128> = Some(30i128);
...
impl std::convert::TryFrom<i128> for ValidationDelayInt {
    type Error = crate::types::bounded_integer::BoundedIntegerError;
    fn try_from(value: i128) -> Result<Self, Self::Error> {
        crate::types::bounded_integer::BoundedInteger::new(value)
    }
}
impl ::serde::Serialize for ValidationDelayInt {
...
impl<'de> ::serde::Deserialize<'de> for ValidationDelayInt {
