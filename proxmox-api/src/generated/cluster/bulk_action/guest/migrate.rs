    ...
    T: crate::client::Client,
{
    ...
    #[doc = ""]
    #[doc = "The 'VM.Migrate' permission is required on '/' or on '/vms/\\<ID\\>' for each ID passed via the 'vms' parameter."]
...
pub struct PostParams {
    ...
    #[serde(skip_serializing_if = "Option::is_none", default)]
    #[doc = "Enable live migration for VMs and restart migration for CTs."]
    #[doc = ""]
