    ...
    T: crate::client::Client,
{
    ...
    #[doc = ""]
    #[doc = "Permission check: perm(\"/mapping/pci\", [\"Mapping.Modify\"])"]
    ...
    T: crate::client::Client,
{
    #[doc = "Get PCI Mapping."]
    #[doc = ""]
    #[doc = "Permission check: or(perm(\"/mapping/pci/{id}\", [\"Mapping.Use\"]), perm(\"/mapping/pci/{id}\", [\"Mapping.Modify\"]), perm(\"/mapping/pci/{id}\", [\"Mapping.Audit\"]))"]
    ...
    T: crate::client::Client,
{
    ...
    #[doc = ""]
    #[doc = "Permission check: perm(\"/mapping/pci/{id}\", [\"Mapping.Modify\"])"]
