    ...
    T: crate::client::Client,
{
    ...
    #[doc = ""]
    #[doc = "Only lists entries where you have 'Mapping.Modify', 'Mapping.Use' or 'Mapping.Audit' permissions on '/mapping/pci/\\<id\\>'."]
...
impl PostParams {
    pub fn new(id: String, map: Vec<String>) -> Self {
        Self {
            ...
            live_migration_capable: ::std::default::Default::default(),
