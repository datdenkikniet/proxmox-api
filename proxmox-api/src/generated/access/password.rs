...
impl PutParams {
    pub fn new(password: PasswordStr, userid: UseridStr) -> Self {
        Self {
            password,
            userid,
...
pub struct PutParams {
    ...
    #[doc = ""]
    pub confirmation_password: Option<ConfirmationPasswordStr>,
...
pub struct ConfirmationPasswordStr {
    value: String,
}
impl crate::types::bounded_string::BoundedString for ConfirmationPasswordStr {
...
impl std::convert::TryFrom<String> for ConfirmationPasswordStr {
    type Error = crate::types::bounded_string::BoundedStringError;
    fn try_from(value: String) -> Result<Self, Self::Error> {
        crate::types::bounded_string::BoundedString::new(value)
    }
}
impl ::serde::Serialize for ConfirmationPasswordStr {
...
impl<'de> ::serde::Deserialize<'de> for ConfirmationPasswordStr {
