...
impl<T> crate::proxmox_client::ProxmoxClientAction<(), GetOutput, T::Error> for &LvmClient<T>
where
    T: crate::client::Client,
{
...
impl<T> crate::proxmox_client::ProxmoxClientAction<PostParams, String, T::Error> for &LvmClient<T>
where
    T: crate::client::Client,
{
