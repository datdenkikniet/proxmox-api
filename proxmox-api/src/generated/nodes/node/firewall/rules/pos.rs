...
impl<'a, T> crate::ProxmoxClient for &'a PosClient<T>
where
    T: crate::client::Client,
{
    type Path = &'a str;
...
impl<T> crate::proxmox_client::ProxmoxClientAction<DeleteParams, (), T::Error> for &PosClient<T>
where
    T: crate::client::Client,
{
...
impl<T> crate::proxmox_client::ProxmoxClientAction<(), GetOutput, T::Error> for &PosClient<T>
where
    T: crate::client::Client,
{
...
impl<T> crate::proxmox_client::ProxmoxClientAction<PutParams, (), T::Error> for &PosClient<T>
where
    T: crate::client::Client,
{
