...
impl<T> crate::proxmox_client::ProxmoxClientAction<(), GetOutput, T::Error> for &HostsClient<T>
where
    T: crate::client::Client,
{
...
impl<T> crate::proxmox_client::ProxmoxClientAction<PostParams, (), T::Error> for &HostsClient<T>
where
    T: crate::client::Client,
{
