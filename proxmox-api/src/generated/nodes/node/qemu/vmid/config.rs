...
pub struct BackgroundDelayInt(i128);
impl crate::types::bounded_integer::BoundedInteger for BackgroundDelayInt {
...
impl std::convert::TryFrom<i128> for BackgroundDelayInt {
    type Error = crate::types::bounded_integer::BoundedIntegerError;
    fn try_from(value: i128) -> Result<Self, Self::Error> {
        crate::types::bounded_integer::BoundedInteger::new(value)
    }
}
impl ::serde::Serialize for BackgroundDelayInt {
...
impl<'de> ::serde::Deserialize<'de> for BackgroundDelayInt {
