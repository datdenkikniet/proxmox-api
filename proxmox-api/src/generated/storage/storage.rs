...
impl<T> crate::proxmox_client::ProxmoxClientAction<(), (), T::Error> for &StorageClient<T>
where
    T: crate::client::Client,
{
...
impl<T> crate::proxmox_client::ProxmoxClientAction<(), GetOutput, T::Error> for &StorageClient<T>
where
    T: crate::client::Client,
{
